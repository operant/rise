...
C_Dialog_Choice = {
	...
	if (!(createDialog "Option_window_2")) exitWith {hint "Dialog Error! Return to lobby and join again!";};
...
C_Dialog_Full = {
	...
	if (!(createDialog "Clothes_Dialog")) exitWith {hint "Dialog Error! Return to lobby and join again!";};
	[] call C_Dialog_Setup;
