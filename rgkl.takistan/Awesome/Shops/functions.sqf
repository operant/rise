...
shop_sell_select_vehicle_wait = {
	...
	if (!(createDialog "ShopVehicles")) exitWith {hint "Dialog Error! Return to lobby and join again!"};
...
shop_open_dialog = {
	...
	if (!(createDialog "Shops")) exitWith {hint "Dialog Error! Return to lobby and join again!"};
