...
if ("ziptie_vip" call INV_GetItemAmount < 1) exitwith {player groupchat "You need a zip tie in your inventory in order to use this."};
if ("ziptie_don" call INV_GetItemAmount < 1) exitwith {player groupchat "You need a zip tie in your inventory in order to use this."};
