...
{
if (!(createDialog "distribute4")) exitwith {hint "Dialog Error! Return to lobby and join again!"};
...
{
if (!(createDialog "CheckDialog")) then {hint "Dialog Error! Return to lobby and join again!"};
