...
player globalChat "- GCam Controls -";
player globalChat "W, A, S, D, Q, Z, 2, X : Camera Move";
player globalChat "Mouse Move, Drag (list opend) : Camera Turn";
player globalChat "Mouse Wheel : Camera Zoom";
player globalChat "Mouse L Click : Switch Screen Centered Unit";
player globalChat "Mouse R Click : Zoom Default";
player globalChat "Cursor Up/Down (list closed) : Switch Unit in Group";
player globalChat "Cursor Left/Right (list closed) : Switch Group";
player globalChat "L : Unit List and Search Map";
player globalChat "Mouse L Click : Scan and Show Nearby Groups";
player globalChat "Mouse L Click (on marker) : Switch Unit";
player globalChat "N : Night / Thermal Vision";
player globalChat "B : Toggle Behind Mode";
player globalChat "F : Toggle Follow Mode";
player globalChat "C : Toggle Focus Mode";
player globalChat "T : Toggle Firing and Ejection Trigger";
player globalChat "V : Change Camera View Mode";
player globalChat "Space : Quit";
...
<t color='#8a8aff'>getPosATL</t>: %9<br/>
